      ...
      <el-container>
        ...
        <el-main :style="{ left: 200 - isCollapse * 144 + 'px' }">
          ...
          <el-input
            ...
            style="width: 300px"
          /><br /><br /><br />
          <span style="position: absolute; left: 380px; top: 400px"
            >我的签名</span
          ><br />
          <el-input
            v-model="changeSign"
          ...
          <el-button
            type="primary"
            @click="changeInfo()"
            style="position: absolute; top: 580px; left: 630px"
            >确认提交</el-button
          >
          <el-button
            @click="this.$router.push('/personalInfo')"
            style="position: absolute; top: 580px; left: 750px"
            >取消</el-button
          >
        </el-main>
      </el-container>
